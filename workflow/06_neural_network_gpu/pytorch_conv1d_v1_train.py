...
progress_file = f'{working_dir}progress/progress_conv1d_v1_train_{current_time}.txt'
...
results_df = pd.DataFrame({
    'y_train': all_targets.flatten(),
    'y_pred': all_predictions.flatten()
})

# Save the DataFrame to a CSV file
results_df.to_csv(f'{working_dir}predictions/predictions_conv1d_train_{current_time}.csv', index=False)

print(f"Predictions and true values saved to predictions_conv1d_train_{current_time}.csv.")