#!/bin/bash
#SBATCH --job-name=nn-pytorch-train
...
# Run Python script
conda run -p /group/pmc021/amunif/env/pytorch python /group/pmc021/amunif/epi-thesis/workflow/06_neural_network_gpu/pytorch_nn_train.py
