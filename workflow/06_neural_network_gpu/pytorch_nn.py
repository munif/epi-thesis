...
progress_file = f'{working_dir}progress/progress_nn_{current_time}.txt'
...
LOG_DIR = f"{working_dir}runs/nn_model"
...
results_df.to_csv(f"{working_dir}predictions/nn_predictions_{current_time}.csv", index=False)
