...
# Load histone data
data_df = pl.read_parquet(os.path.join(DATASET_PATH, 'donor4_exp_histones.parquet'))
data_df
...
for number in range(START, END):
    ...
    X = data_df["gene_id", "histone", "value"]
    X_np = X.to_numpy()
