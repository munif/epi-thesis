...
# Run Python script
conda run -p /group/pmc021/amunif/env/pytorch python /group/pmc021/amunif/epi-thesis/workflow/10_Permutation_Test_Ranking/slurm/E066/ranking_permutation_E066.py 240 250
