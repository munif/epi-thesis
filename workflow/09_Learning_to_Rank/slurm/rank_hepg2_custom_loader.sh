#!/bin/bash
#SBATCH --job-name=rank_custom_loader
...
# Run Python script
conda run -p /group/pmc021/amunif/env/pytorch python /group/pmc021/amunif/epi-thesis/workflow/09_Learning_to_Rank/slurm/rank_hepg2_custom_loader.py
