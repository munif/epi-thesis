...
#SBATCH --output=/group/pmc021/amunif/epi-thesis/workflow/07_deepchrome/slurm/%x-%j.out
#SBATCH --error=/group/pmc021/amunif/epi-thesis/workflow/07_deepchrome/slurm/%x-%j.err
#SBATCH --nodes=1
