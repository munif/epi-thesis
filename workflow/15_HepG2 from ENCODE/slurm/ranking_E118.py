...
OUTPUT_PATH = "/group/pmc021/amunif/epi-thesis/workflow/15_HepG2 from ENCODE/output/"
...
# Load histone data
data_df = pl.read_parquet(os.path.join(DATASET_PATH, 'E118_exp_histones.parquet'))
data_df
...
for number in range(START, END):
    ...
    X = data_df["gene_id", "histone", "E118"]
    X_np = X.to_numpy()
