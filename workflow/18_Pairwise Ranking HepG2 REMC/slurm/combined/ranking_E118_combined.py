...
# %%
# Folder setup
DATASET_PATH = Path('/group/pmc021/amunif/epi-thesis/workflow/18_Pairwise Ranking HepG2 REMC/dataset/')
OUTPUT_PATH  = Path('/group/pmc021/amunif/epi-thesis/workflow/18_Pairwise Ranking HepG2 REMC/output/combined')
...
# %%
# Data Loading
data_df = pl.read_parquet(DATASET_PATH / 'E118_exp_histones.parquet')
...
def generate_pairs_with_labels(data_df, indexes, num_pairs, seed):
    ...
    val_1  = data_df["E118"][idx[:, 0]].to_numpy()
    val_2  = data_df["E118"][idx[:, 1]].to_numpy()
