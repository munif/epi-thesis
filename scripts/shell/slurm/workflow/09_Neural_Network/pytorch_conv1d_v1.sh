#!/bin/bash
#SBATCH --job-name=09-pytorch-conv1d-gpu
...
# Run Python script
conda run -n epi-thesis python /group/pmc021/amunif/epi-thesis/scripts/shell/slurm/workflow/09_Neural_Network/pytorch_conv1d_v1.py
